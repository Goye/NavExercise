...
/******/ 	var hotCurrentHash = "6847602be05f1b115994"; // eslint-disable-line no-unused-vars
...
_exports.AssertionError = __webpack_require__(4);
...
_exports.test = __webpack_require__(38);

/*!
 * type utility
 */

_exports.type = __webpack_require__(3);

/*!
 * expectTypes utility
 */
_exports.expectTypes = __webpack_require__(29);
...
_exports.getActual = __webpack_require__(5);

/*!
 * Inspect util
 */

_exports.inspect = __webpack_require__(2);

/*!
 * Object Display util
 */

_exports.objDisplay = __webpack_require__(9);
...
_exports.transferFlags = __webpack_require__(10);
...
_exports.getPathValue = __webpack_require__(32);

/*!
 * Deep path info
 */

_exports.getPathInfo = __webpack_require__(7);

/*!
 * Check if a property exists
 */

_exports.hasProperty = __webpack_require__(8);

/*!
 * Function name
 */

_exports.getName = __webpack_require__(6);

/*!
 * add Property
 */

_exports.addProperty = __webpack_require__(28);

/*!
 * add Method
 */

_exports.addMethod = __webpack_require__(27);

/*!
 * overwrite Property
 */

_exports.overwriteProperty = __webpack_require__(37);

/*!
 * overwrite Method
 */

_exports.overwriteMethod = __webpack_require__(36);

/*!
 * Add a chainable method
 */

_exports.addChainableMethod = __webpack_require__(26);

/*!
 * Overwrite chainable method
 */

_exports.overwriteChainableMethod = __webpack_require__(35);
...
/******/(function (modules) {
  ...
  /******/
  /******/var hotApplyOnUpdate = true;
  /******/var hotCurrentHash = "436734bd57f3433e1d86"; // eslint-disable-line no-unused-vars
  /******/var hotCurrentModuleData = {};
  /******/var hotCurrentChildModule; // eslint-disable-line no-unused-vars
  /******/var hotCurrentParents = []; // eslint-disable-line no-unused-vars
  /******/var hotCurrentParentsTemp = []; // eslint-disable-line no-unused-vars
...
/***/function (module, exports, __webpack_require__) {
  ...
  var Data = function () {
    ...
    */
    ...
    _createClass(Data, [{
      key: "getJson",
      value: async function getJson(path) {
    ...
    */
    ...
    _createClass(Nav, [{
      ...
      value: function buildNav() {
        ...
        this.toggleButtonOpen.addEventListener('click', function () {
          return _this.buttonListener(event);
        });
        this.toggleButtonClose.addEventListener('click', function () {
          return _this.buttonListener(event);
        });
      }
      ...
      */
      ...
      key: 'htmlCode',
      value: function htmlCode() {
        var _this2 = this;

        var rootElement = '';
        this.data.items.map(function (elem, index) {
          if (elem.items.length > 0) {
            var children = _this2.htmlChildren(elem.items);
      ...
      */
      ...
      key: 'htmlChildren',
      value: function htmlChildren(nodes) {
        var elements = '<ul class="submenu">';
      ...
      */
      ...
      key: 'buttonListener',
      value: function buttonListener(event) {
      ...
      */
      ...
      value: function clickOutside(event) {
        ...
        var inside = document.querySelector('.main-nav').contains(event.target);
        var openButton = this.toggleButtonOpen.contains(event.target);
        if (!inside && !openButton) {
          this.navClose();
          this.closeAllMenus();
        }
        document.removeEventListener('click', function () {
          return _this3.clickOutside(event);
        });
      }
      ...
      */
      ...
      value: function addOutsideListener() {
        var _this4 = this;

        document.addEventListener('click', function () {
          return _this4.clickOutside(event);
        });
      }
      ...
      */
      ...
      key: 'addMenuListeners',
      value: function addMenuListeners() {
        var _this5 = this;

        var menus = document.querySelectorAll('.has-children');
        menus.forEach(function (el) {
          el.addEventListener('click', function () {
            return _this5.submenuListener(event);
          });
        });
        window.addEventListener('resize', function () {
          return _this5.checkScreenSize(event);
        });
      ...
      */
      ...
      key: 'submenuListener',
      value: function submenuListener(event) {
...
/***/function (module, exports, __webpack_require__) {
   ...
   */
  (async function () {
    var dataNav = new _data2.default();
    var configObj = new _config2.default();
    dataNav = await dataNav.getJson(configObj.jsonPath);
    var hugeNav = new _nav2.default(dataNav);
  })();
...
(function webpackMissingModule() { throw new Error("Cannot find module \"tests-bundle.js\""); }());
